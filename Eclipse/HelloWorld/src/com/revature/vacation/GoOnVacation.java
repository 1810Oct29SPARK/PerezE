...
public class GoOnVacation {
	...
	public static void main(String[] args) {
		...
		Vehicle[] vehicles = {new Tornado(147.2), new Kayak("red", 4.2, 2, 2), new Car(2021, "spaceship", "Tesla", 50), new Tornado (1520)};
	...
	static Vehicle chooseAVehicle(Vehicle[] garage) {
		...
		//check for steerable vehciles that are not boats, choose first one
