...
public class Scopes {
	...
	/*
	 * this is a value that all instances will have
	...
	/*
	 * write a constructor with an argument of variable variable2
	...
	public static void main(String[] args) {
		...
		System.out.println(s.variable2); //variable 2 is defined for an instance of the class
		s.myMethod("this is an argument to myMethode");
	}
	...
	public void myMethod(String variable3) {
		...
		//is is only defined for the for loop block scope
		//System.out.println("value of i is: "+i);
